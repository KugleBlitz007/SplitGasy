...
import 'package:splizzy/pages/group_page.dart';
...
class GroupListItem extends StatelessWidget {
  ...
  Widget _buildListTile(BuildContext context, double balance, bool hasAnyBills) {
    return Container(
      ...
      builder: (context, balanceSnapshot) {
        return StreamBuilder<QuerySnapshot>(
          ...
          builder: (context, billSnapshot) {
            ...
            bool hasAnyBills = false;
            
            if (balanceSnapshot.hasData && currentUser != null) {
              for (var doc in balanceSnapshot.data!.docs) {
            ...
            if (billSnapshot.hasData) {
              hasAnyBills = billSnapshot.data!.docs.isNotEmpty;
            }
                ...
                child: Container(
                  ...
                  child: Material(
                    ...
                    child: InkWell(
                      ...
                      borderRadius: BorderRadius.circular(10),
                      child: _buildListTile(context, groupBalance, hasAnyBills),
                    ),
                  ),
                ),
              ),
